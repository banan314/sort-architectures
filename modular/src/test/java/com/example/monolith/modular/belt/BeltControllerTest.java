package com.example.monolith.modular.belt;

import com.example.monolith.modular.belt.controllers.BeltController;
import com.example.monolith.modular.belt.handlers.ControllerExceptionHandler;
...
class BeltControllerTest {
    ...
    void testSortItems_Failure() throws Exception {
        doThrow(new ItemsSortingException("Sorting failed")).when(beltService).sortItems();
